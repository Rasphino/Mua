    ...
    private static void helper(ASTreeNode node) {
        ...
        if (opr_name.equals("make")) {
            ...
            if (value.equals("true") || value.equals("false")) {
                node.setData(new AbstractMap.SimpleEntry<String, Lexer.TokType>(value, Lexer.TokType.Bool));
            } else if (Lexer.isNumeric(value)) {
                node.setData(new AbstractMap.SimpleEntry<String, Lexer.TokType>(value, Lexer.TokType.Number));
            } else {
            ...
            if (Main.name_space.containsKey(key))
                node.setData(new AbstractMap.SimpleEntry<String, Lexer.TokType>("true", Lexer.TokType.Bool));
            else
                node.setData(new AbstractMap.SimpleEntry<String, Lexer.TokType>("false", Lexer.TokType.Bool));
            ...
            node.setData(new AbstractMap.SimpleEntry<String, Lexer.TokType>(res, Lexer.TokType.Number));
            ...
            if ((Lexer.isNumeric(left_str) && isParseableNumber(right_str)) ||
                ...
                node.setData(new AbstractMap.SimpleEntry<String, Lexer.TokType>(res, Lexer.TokType.Bool));
            } else {
